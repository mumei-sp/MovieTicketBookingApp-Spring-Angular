...
/*
	...
	public void addTheatre() throws Exception {
		...
		Theatre th = new Theatre("Kabuki", "Tokyo", "Vidhya", "998990181");
	...
	public void addMovie() throws Exception {
		...
		Movie mov = new Movie("Avengers", "scifi", "04", "English", "Good", LocalDate.of(2007, 12, 03));
	...
	public void addAScreen() throws Exception {
		...
		Theatre th = new Theatre("Kabuki", "Tokyo", "Vidhya", "998990181");
		Screen sc = new Screen(th, "screen1", 4, 8);
	...
	public void addShow() throws Exception {
		...
		Show sh = new Show(LocalDateTime.of(2020, 10, 29, 7, 4, 2, 0), LocalDateTime.of(2020, 10, 29, 9, 4, 2, 0),
				"MorningShow", null, sc, th, LocalDate.of(2021, 04, 28));
	...
	public void addASeat() throws Exception {
		...
		Seat st = new Seat("c12", "front", 25, null);
	...
	public void addATicket() throws Exception {
		...
		Booking boo = new Booking(null, LocalDate.of(2007, 12, 03), "Online", "pending", 100, null);
